    ...
    class RateDialogHandler {
        ...
        processNode(node) {
            ...
            if (node.classList && node.classList.contains('modal-header-E8CcJ7Y')) {
                this.enhanceDialogHeader(node);
            } else if (node.querySelector) {
                const header = node.querySelector('.modal-header-E8CcJ7Y');
                if (header) {
                    this.enhanceDialogHeader(header);
                }
            }
        ...
        checkExistingDialogs() {
            ...
            headers.forEach(header => this.enhanceDialogHeader(header));
        }
        ...
        showRateMark(rateElement, isSuccess) {
            ...
            markElement.style.cssText = 'display: inline-block; margin-right: 6px; font-size: 1em; font-weight: bold; vertical-align: middle; line-height: 1;';
